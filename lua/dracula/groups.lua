...
local function setup(configs)
   ...
   return {
      ...
      ["@string"] = { fg = colors.bright_cyan },
      ["@string.javascript"] = { fg = colors.cyan },
      ...
      ["@lsp.type.parameter"] = { fg = colors.cyan, bold = true },
      ["@lsp.type.property"] = { fg = colors.purple },
      ["@lsp.type.struct"] = { fg = colors.cyan },
      ["@lsp.type.type"] = { fg = colors.bright_cyan },
      ["@lsp.type.variable"] = { fg = colors.fg },
      ["@lsp.type.function.javascript"] = { fg = colors.green, bold = true },
      ["@type.javascript"] = { fg = colors.green, bold = true, italic = true },
